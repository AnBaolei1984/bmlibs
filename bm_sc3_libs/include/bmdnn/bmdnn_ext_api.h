...
bm_status_t bmdnn_stride_slice(
    bm_handle_t      handle,
    bm_device_mem_t  input,
    int              shape_size,
    int              input_n,
...
bm_status_t bmdnn_topk(
    ...
    int              input_h,
    int              input_w,
    bm_device_mem_t  output_value,
    bm_device_mem_t  output_index
        );

bm_status_t bmdnn_where(
    bm_handle_t      handle,
    bm_device_mem_t  input,
    float               dim_size,
    int                 input_n,
